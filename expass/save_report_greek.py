...
from analyze_edge_explanation_greek import analyze_important_edges, load_toxigen_data
...
def main():
    ...
    texts_df = texts_df.dropna(subset=["Tweet, text"]).reset_index(drop=True)
    ...
    for _, row in edges_df.iterrows():
        ...
        enriched_data.append({
            ...
            "source_text": source_row.get("Tweet, text", "N/A") if source_row is not None else "N/A",
            "target_text": target_row.get("Tweet, text", "N/A") if target_row is not None else "N/A",
        })
